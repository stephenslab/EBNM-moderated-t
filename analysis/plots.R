...
resscore$method = replace(resscore$method,resscore$method=="VL+eBayes+ash","VL+eBayes+ash")
...
resscore2 = filter(resscore, method %in% c("VL+eBayes+qval","VL+pval2se+ash",
                                           "VL+eBayes+ash", "VL+eBayes+ash.alpha=1"))
resscore3 = filter(resscore, method %in% c("edgeR+qval","VL+eBayes+qval",
                                           "VL+pval2se+ash"))
# uncomment to include DESeq2 results
...
setEPS()
postscript('figures/pi0est_indep.eps',width=8,height=8)
...
setEPS()
postscript('figures/fdp_indep.eps',width=8,height=8)
...
setEPS()
postscript('figures/fdp_qval_indep.eps',width=8,height=8)
...
setEPS()
postscript('figures/fsp_indep.eps',width=8,height=8)
...
setEPS()
postscript('figures/dp_indep.eps',width=8,height=8)
...
setEPS()
postscript('figures/rmse_indep.eps',width=8,height=8)
...
# setEPS()
# postscript('figures/auc_indep.eps',width=8,height=8)
...
# setEPS()
# postscript('figures/dprel_indep.eps',width=8,height=8)
...
save_latex_coverage_table(reslong.neg %>% group_by(scenario,method) %>% summarize(lt = mean(value<coverthresh)) %>% separate(scenario,c("scenario","nsamp"),",nsamp="),
                          c("VL+eBayes+ash"),"tables/coverage_neg.tex")
save_latex_coverage_table(reslong.pos %>% group_by(scenario,method) %>% summarize(lt = mean(value<coverthresh)) %>% separate(scenario,c("scenario","nsamp"),",nsamp="),
                          c("VL+eBayes+ash"),"tables/coverage_pos.tex")
save_latex_coverage_table(reslong %>% group_by(scenario,method) %>% summarize(lt = mean(value<coverthresh)) %>% separate(scenario,c("scenario","nsamp"),",nsamp="),
                          c("VL+eBayes+ash"),"tables/coverage_all.tex")
...
setEPS()
postscript('figures/pi0est_dep.eps',width=10,height=10)
...
setEPS()
postscript('figures/pi0est2_dep.eps',width=10,height=10)
...
setEPS()
postscript('figures/fdp_dep.eps',width=10,height=10)
...
setEPS()
postscript('figures/fdp2_dep.eps',width=10,height=10)
...
setEPS()
postscript('figures/fsp_dep.eps',width=10,height=10)
...
setEPS()
postscript('figures/fsp2_dep.eps',width=10,height=10)
...
# setEPS()
# postscript('figures/auc_dep.eps',width=8,height=8)
# fdp_plot=ggplot(resscore1,
...
# setEPS()
# postscript('figures/auc2_dep.eps',width=8,height=8)
...
setEPS()
postscript('figures/rmse_dep.eps',width=8,height=8)
rmse_plot=ggplot(test,
                 aes(pi0,rmse.beta_rel,colour=method)) +geom_point(shape=1) +
  facet_grid(nsamp ~ scenario) +
  guides(alpha=FALSE) +
...
#
# setEPS()
# postscript('figures/rmse2_dep.eps',width=8,height=8)
...
save_latex_coverage_table(reslong.neg %>% group_by(scenario,method) %>% summarize(lt = mean(value<coverthresh)) %>% separate(scenario,c("scenario","nsamp"),",nsamp="),
                          c("VL+eBayes+ash"),"tables/coverage_neg_dep.tex")
save_latex_coverage_table(reslong.pos %>% group_by(scenario,method) %>% summarize(lt = mean(value<coverthresh)) %>% separate(scenario,c("scenario","nsamp"),",nsamp="),
                          c("VL+eBayes+ash"),"tables/coverage_pos_dep.tex")
save_latex_coverage_table(reslong %>% group_by(scenario,method) %>% summarize(lt = mean(value<coverthresh)) %>% separate(scenario,c("scenario","nsamp"),",nsamp="),
                          c("VL+eBayes+ash"),"tables/coverage_all_dep.tex")
...
# setEPS()
# postscript('figures/pvalks_indep_null.eps',width=8,height=8/3)
...
setEPS()
postscript('figures/npval005_indep_null.eps',width=8,height=8/3)
...
# setEPS()
# postscript('figures/npval_indep_null.eps',width=8,height=8)
...
setEPS()
postscript('figures/npval_indep_null.eps',width=6,height=6)
...
setEPS()
postscript('figures/dp_indep_null.eps',width=8,height=8/3)
...
setEPS()
postscript('figures/pi0est_indep_null.eps',width=8,height=8/3)
...
setEPS()
postscript('figures/npval_dep_null.eps',width=6,height=6)
npval_plot = ggplot(npvalsum, aes(x=log10(thres), y=mean/thres, colour=method)) +
  facet_grid(~nsamp) +
  geom_abline(slope=0,intercept=1,linetype="dashed") +
  geom_errorbar(width=0.3,aes(ymin=low/thres, ymax=upp/thres)) +
...
setEPS()
postscript('figures/pvalks_dep_null.eps',width=8,height=8/3)
pval_ks_plot = ggplot(resscore, aes(method,pval.ks)) +geom_boxplot() +
  facet_grid(~nsamp) +
  geom_abline(slope=0,intercept=0.05,colour="red") +
  xlab("Methods") +
...
setEPS()
postscript('figures/npval005_dep_null.eps',width=8,height=8/3)
npval_005_plot = ggplot(resscore, aes(method,npval.005)) +geom_boxplot() +
  facet_grid(~nsamp) +
  geom_abline(slope=0,intercept=0.05,colour="red") +
  xlab("Methods") +
...
setEPS()
postscript('figures/npval_dep_null.eps',width=8,height=8)
...
setEPS()
postscript('figures/npval_dep_null.eps',width=8,height=4)
...
setEPS()
postscript('figures/dp_dep_null.eps',width=8,height=8/3)
dp_plot = ggplot(resscore2, aes(method,DP_005)) +geom_boxplot() +
  facet_grid(~nsamp) +
  xlab("Methods") +
  ylab("Proportion of genes with q<0.05")
...
setEPS()
postscript('figures/pi0est_dep_null.eps',width=8,height=8/3)
pi0_plot = ggplot(resscore2, aes(method,pi0.est)) +geom_boxplot() +
  facet_grid(~nsamp) +
  xlab("Methods") +
  ylab("Estimated pi0")
...
setEPS()
postscript('figures/scenario_dens.eps',width=10,height=2)
